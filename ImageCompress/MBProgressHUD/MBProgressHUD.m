...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
         ...
         */
        self.autoresizingMask = NSViewAutoresizingFlexibleTopMargin | NSViewAutoresizingFlexibleBottomMargin | NSViewAutoresizingFlexibleLeftMargin | NSViewAutoresizingFlexibleRightMargin;
#endif  // (TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE)
...
#endif
#if __has_feature(objc_arc)
            [_finColors replaceObjectAtIndex:i
                                  withObject:[_foreColor colorWithAlphaComponent:alpha]];
#else
            [_finColors[i] release];
...
#if __has_feature(objc_arc)
        [_finColors replaceObjectAtIndex:i
                              withObject:[_foreColor colorWithAlphaComponent:newAlpha]];
#else
...
#endif
#if __has_feature(objc_arc)
        [_finColors replaceObjectAtIndex:_position
                              withObject:_foreColor];
#else
